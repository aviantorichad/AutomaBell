...
<table cellspacing="0">
	...
	$qtab = mysql_query("SELECT * FROM resume WHERE hari='$day' ORDER BY hari ASC, jam ASC") or die("gagal query [".mysql_error()."] <a href='javascript:history.back()'>back</a>");
	...
	<tr bgcolor="<?php echo $warna; ?>">
		<td><?php echo $no; ?></td><td><?php echo $res_hr; ?></td><td><?php echo $res_jm; ?></td><td><?php echo $res_jw; ?></td><td><?php echo $res_fl; ?></td>
	</tr>
	<?php 
	$no++;
	} 
